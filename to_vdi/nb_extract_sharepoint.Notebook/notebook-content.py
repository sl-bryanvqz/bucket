...
SourceConnectionSettings = '{ "BaseUrl": "https://api.powerbi.com/v1.0/myorg/admin", "Authentication": "Service Principal", "KvUri": "https://kv-fabricmonitor.vault.azure.net/", "AppClientId": "mcoe-pbi-showcase-sp-client-id", "AppTenantId": "mcoe-pbi-showcase-sp-tenant-id", "AppSecret": "mcoe-pbi-showcase-sp-secret", "GrantType": "client_credentials", "AuthenticationBaseUrl": "https://login.microsoftonline.com", "AuthenticationResource": "https://analysis.windows.net/powerbi/api"}'
...
if kv_uri:
    ...
    kv_uri = 'https://kv-fabricmonitor.vault.azure.net/'
    app_tenant_id = notebookutils.credentials.getSecret(kv_uri, 'mcoe-pbi-showcase-sp-tenant-id')
    app_client_id = notebookutils.credentials.getSecret(kv_uri, 'mcoe-pbi-showcase-sp-client-id')
    app_secret = notebookutils.credentials.getSecret(kv_uri, 'mcoe-pbi-showcase-sp-secret')
